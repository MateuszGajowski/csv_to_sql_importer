...
public class BondReaderConfiguration {
    ...
    public FlatFileItemReader<Bond> bondReader(@Value("#{stepExecutionContext['fileName']}") String file,
                                               FileBatchImporterProperties bondConfigurationProperties) {
        ...
        return new FlatFileItemReaderBuilder<Bond>()
                ...
                .delimited()
                .delimiter(bondConfigurationProperties.getDelimeter())
                .names(new String[]{"error", "errorText", "isin", "mvUnitNotional", "scenarioDate", "scenarioSpecId", "tradehubMessageId", "type", "zeroSimulation"})
                .linesToSkip(1)
